        ...
        <div class="registration">                                  
            <div class="container">
                ...
                <div class="left">
                    ...
                    <div class="para2"> <h1>Blog Circle</h1> </div><br><br>
                ...
                <div class="do-log">Already have an account?<a href="login.php">Login</a></div>
                </div>
                <div class="right">
                    <div class="reg-box">
                      <form method="post" action="" enctype="multipart/form-data" onsubmit="return validreg()" >
                            ...
                            <span id='message'></span>
                               <p><input type="text" id="uname" name="uname" placeholder="User Name"></p>
                                <button type="submit" class="sub-reg" name="submit"  ><h1>Register<h1></button>
